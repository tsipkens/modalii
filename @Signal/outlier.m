function [] = outlier(signal)
%Remove outliers from two color LII data using Thompson tau
%   examine each channel in sequence - if one element is removed, the other
%   is also removed
