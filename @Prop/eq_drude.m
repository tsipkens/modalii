...
function [Em,n,k] = drude(prop,lambda)
...
epsilon1 = ones(p,q)-prop.omega_p.^2*prop.tau.^2./(ones(p,q)+omega.^2*prop.tau.^2);
epsilon2 = prop.omega_p.^2.*prop.tau./(omega.*(ones(p,q)+omega.^2*prop.tau.^2));
